...
const translations = {
  zh: {
    ...
    internship: {
      ...
      formulaTitle: '评分公式',
      formulaText: '通勤评分公式：30分钟内满分100，超过后每10分钟减6分。日薪评分：50元=0分，300元=100分，线性映射。工作强度/氛围/前景：1-10分，直接对应10-100分。总分 = 日薪×0.25 + 体验×0.40 + 前景×0.35',
      offers: '实习Offer',
      add: '添加',
  ...
  en: {
    ...
    internship: {
      ...
      formulaText: 'Commute: 100 pts within 30min, -6 pts per 10min after. Salary: 50 CNY=0 pts, 300 CNY=100 pts, linear. Intensity/Atmosphere/Prospect: 1-10 = 10-100 pts. Total = Salary×0.25 + Experience×0.40 + Prospect×0.35',
      offers: 'Offers',
      add: 'Add',
